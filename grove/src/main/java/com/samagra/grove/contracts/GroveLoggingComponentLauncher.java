...
import com.samagra.grove.logging.UCEHandler;
...
public class GroveLoggingComponentLauncher implements IGroveLoggingComponent {
    ...
    public void initializeLoggingComponent(
        ...
        initExceptionHandler(isUCEHEnabled, senderEmailID, receiverEmailID);
    }


    private void initExceptionHandler(boolean isUCEHEnabled, String senderEmailID, String receiverEmailID) {
        new UCEHandler.Builder(mApplication)
                .setUCEHEnabled(isUCEHEnabled)
                .setSendingUserEmailId(senderEmailID)
                .setReceivingUserEmailId(receiverEmailID)
                .setErrorActivityHandler(errorActivityHandler)
